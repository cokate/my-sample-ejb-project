...
public class ScheduledStatelessSessionBean {
	 ...
	 * 
	 * @param inTimer
	 *            Timer that caused the timeout callback invocation.
	 */
	...
	private void cancelOverdue(final Timer inTimer) throws IllegalStateException, NoSuchObjectLocalException, EJBException {
